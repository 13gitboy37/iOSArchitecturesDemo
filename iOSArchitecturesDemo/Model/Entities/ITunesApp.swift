...
public struct ITunesApp: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.version = (try? container.decode(String.self, forKey: .version)) ?? "1.0.0"
        self.releaseNotes = (try? container.decode(String.self, forKey: .releaseNotes)) ?? ""
        self.currentVersionReleaseDate = (try? container.decode(String.self, forKey: .currentVersionReleaseDate)) ?? "11.11.2011"
    }
